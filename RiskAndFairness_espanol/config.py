...
data = [
[{'mode': 'probability', 'a_x': 70, 'a_y': 10, 'b_x': 10, 'b_y': 80, 'label': {'x': 'Tus tokens', 'y': "Los tokens de tu compañero"}}],
...
[{'mode': 'sec_ownrisk_fixedother', 'm': 50, 'p_x': 0.6, 'a': 30, 'b': 13.3, 'p_y': 1, 'prob_a': 50, 'fixed': {'m': 43.3, 'p_x': 1, 'p_y': 1, 'a': 30}, 'label': {'x': 'Estado A (50%)', 'y': 'Estado B (50%)'}}],
...
[{'mode': 'det_giv', 'm': 50, 'p_x': 0.5, 'p_y': 1, 'prob_a': 50, 'label': {'x': 'Tus tokens', 'y': "Los tokens de tu compañero"}}],
#     [
    ...
    for block in newdata:
        for dic in block:
            if dic['mode'] in ['sec_1bl_1ch', 'sec_2bl_1ch', 'sec_1bl_2ch', 'sec_ownrisk']:
                ...
                if 'label' not in dic:
                    dic['label'] = {'x': 'Tus Tokens', 'y': 'Los Tokens de tu compañero'}
